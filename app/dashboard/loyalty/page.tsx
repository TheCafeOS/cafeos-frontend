        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-stone-500">
              Define what customers earn and what they need to do to unlock it.
            </p>
          </div>
        </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-stone-500">
                What the customer receives after completing the loyalty goal.
              </p>
            ...
            {/* Purchase threshold */}
            <div className="space-y-2">
              <Label htmlFor="purchaseThreshold">
                Purchases needed
              </Label>

              <p className="text-xs text-stone-500">
                Number of qualifying purchases required to unlock the reward.
              </p>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-stone-500">
                Number of rewards the customer receives when they unlock it.
              </p>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-stone-500">
                Minimum amount each qualifying order must be worth.
              </p>
          ...
          <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4">
            ...
            <p className="mt-1 text-sm leading-6 text-amber-800">
              ...
              <span className="font-semibold">
                {form.purchaseThreshold || 0} qualifying purchases
              </span>{" "}
              with a minimum order value of{" "}
              <span className="font-semibold">
                {formatCurrency(form.minimumOrderValue || 0)}
              </span>{" "}
              each to unlock{" "}
              <span className="font-semibold">
                {form.rewardQuantity || 0} × {form.rewardName || "the reward"}
              </span>
              .
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-2xl border border-stone-200 bg-stone-50 p-4">
                  ...
                  <p className="mt-1 font-medium text-stone-900">
                    {customerProfile.customer.progressCount}
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-stone-200 bg-stone-50 p-4">
                  ...
                  <p className="mt-1 font-medium text-stone-900">
                    {customerProfile.progress.purchaseThreshold}
                  </p>
                </div>
              ...
              <div className="rounded-2xl border border-stone-200 bg-white p-4">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <p className="text-sm text-stone-600">
                    {customerProfile.progress.progressCount} /{" "}
                    {customerProfile.progress.purchaseThreshold}
                  </p>
                </div>
                ...
                {customerProfile.rewards.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {customerProfile.rewards.map((reward) => {
                      const rewardWithRedemption =
                        reward as RewardWithRedemption;
                        ...
                        >
                          ...
                          <div className="mt-3 grid gap-3 sm:grid-cols-2">
                            ...
                            <div>
                              ...
                              <p className="mt-1 text-sm text-stone-700">
                                {formatDate(
                                  rewardWithRedemption.redeemedAt ?? null,
                                )}
                              </p>
                            </div>
                          </div>
